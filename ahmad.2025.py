...
def get_filters():
    """Prompt user to specify a city, month, and day to analyze.

    Returns:
        str: city name to analyze
        str: month to filter by, or "all" to apply no month filter
        str: day to filter by, or "all" to apply no day filter
    """
...
def load_data(city, month, day):
    ...
    Args:
        ...
        day (str): day to filter by, or "all" for no filter
...
def display_raw_data(df):
    """Ask the user if they want to see raw data and display it."""
    row_index = 0
    while True:
